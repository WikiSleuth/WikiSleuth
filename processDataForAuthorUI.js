function buildAuthorHTMLToAdd(tabs, data, callback) {
		if (data.length > 0) {
			html = "<div id='panel'> <h2>WikiSleuth Author Revision History<span class= 'shortcut'>Press CMD+Shift+F to search for new author</span></h2>" + "<form id= 'AuthorSearchBox'> Search By Author <input type = 'text' id = 'Author' name = 'AuthorName'> <input type= 'button' id = 'submitbutton' value = 'Submit' onclick = 'getName()'></form>"+ 	 
